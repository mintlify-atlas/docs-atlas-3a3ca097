...
description: "With 492 fraud cases out of 50,492 transactions, naive classifiers reach 99%+ accuracy by ignoring fraud entirely. Learn how FFD addresses this with a GAN."
---
...
After training, **1,000 synthetic fraud samples** are generated and combined with the original 492 real fraud records, bringing the combined fraud pool to 1,492 samples for the training phase of the downstream classifiers.
